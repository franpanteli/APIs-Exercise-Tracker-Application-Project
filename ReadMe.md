...
[My full notes on how to run the application locally are here](https://github.com/franpanteli/APIs-Exercise-Tracker-Fullstack-Project/blob/main/launching-the-app-locally.txt). First, clone this repository with `git clone [https://github.com/franpanteli/APIs-URL-Shortener-Microservice-Project.git](https://github.com/franpanteli/APIs-Exercise-Tracker-Fullstack-Project.git)`.
